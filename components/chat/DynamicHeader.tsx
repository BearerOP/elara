...
import { ExternalLink, Star, Loader2, Gift, MessageSquare, Settings, LogOut, User } from 'lucide-react'
...
interface DynamicHeaderProps {
  ...
  credits: number
  maxCredits: number
  showActions?: boolean // Show ExternalLink and Star for chat sessions
  isProcessing?: boolean // For wardrobe processing indicator
  processedCount?: number
  totalProcessing?: number
  itemCount?: number // For wardrobe item count
}
      ...
      <header className="flex items-center px-6 py-4 border-b border-[#2a2a2a]">
        ...
        <div className="flex items-center gap-4 flex-1">
          <div className="flex items-center gap-3">
            <h2 className="text-white font-medium text-xl" style={{ lineHeight: '1.26' }}>{title}</h2>
            
            {/* Item count badge for wardrobe */}
            ...
            {/* Action buttons for chat sessions */}
            {showActions && (
              <>
          ...
          {/* Processing Indicator for Wardrobe */}
          {isProcessing && (
            <motion.div
