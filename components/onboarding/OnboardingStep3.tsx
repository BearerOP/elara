      ...
      <div className="flex flex-col gap-4 px-8 pt-16">
        ...
        <div className="mt-2 flex flex-col items-center gap-3">
          ...
          <Button
            ...
            className="flex items-center gap-2 rounded-2xl md:mt-6 border-white/10 bg-white/5 px-5 py-2 text-sm font-medium text-white border hover:bg-white/10 hover:border-white/20"
          >
            {/* Simple upload icon */}
